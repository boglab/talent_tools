...
VALID_PROMOTEROME_ORGANISMS = ['drosophila_melanogaster', 'arabidopsis_thaliana', 'mus_musculus', 'oryza_sativa', 'oryza_sativa_msu7', 'oryza_sativa_rapdb_only', 'caenorhabditis_elegans', 'danio_rerio', 'homo_sapiens', 'rattus_norvegicus', 'brachypodium_distachyon', 'gasterosteus_aculeatus']
